...
# To connect to the internet, change the value to your public IP address
...
#       AF_INET tells the socket that it must accept an IPv4 address
server = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
server.bind(ADDR)

# 5.    To send messages between clients, store the indiv messages globally & run new thread
...
def start():
    ...
    while True:
        ...
        #       store socket object (as conn) which allows us send info back
